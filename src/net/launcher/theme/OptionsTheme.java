...
{	
	...
	public static TextfieldStyle	threads		= new TextfieldStyle(235, 304, 250, 36, "textfield", "font", 16F, Color.DARK_GRAY, Color.WHITE, new EmptyBorder(0, 10, 0, 10));
	...
	public static FontBundle		threadsDesc	= new FontBundle("font", 16F, Color.DARK_GRAY);
