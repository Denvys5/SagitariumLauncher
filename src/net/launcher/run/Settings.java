...
public class Settings
{
	...
	public static final String  baseconf		     = "Sagitarium"; //Папка с файлом конфигурации
	...
	public static final String  siteDir		         = "minenew/site";//Папка с файлами лаунчера на сайте
	public static final String  updateFile		     = "minenew/site/launcher/fix";//Ссылка на обновления лаунчера. Не писать на конце ".exe .jar"!
	...
	public static int     useModCheckerint       =  3;      //Количество раз перепроверки jar во время игры
